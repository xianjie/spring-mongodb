...
/**
 * @Title: MongodbUpdateTest
 * @Description:
 * @author: xian jie
 * @date: 2016-4-27 11:45
 * 杭州尚尚签网络科技有限公司
 * @version: 2.0
 */
...
public class MongodbUpdateTest {
    ...
    public void update() {
        ...
        User userTest1_1 = mongoTemplate.findOne(query1, User.class);
        ...
        User userTest2_1 = mongoTemplate.findOne(query2_1, User.class);
        ...
        User userTest3 = mongoTemplate.findOne(query3, User.class);
        System.out.println("userTest3 - " + userTest3);

        Update update3 = new Update();
        update3.set("age", 100);

        mongoTemplate.updateFirst(query3, update3, User.class);

        Query query3_1 = new Query();
        query3_1.addCriteria(Criteria.where("name").is("appleC"));

        User userTest3_1 = mongoTemplate.findOne(query3_1, User.class);
        ...
        // update 1004 only.
        // mongoTemplate.updateFirst(query4, update4, User.class);

        // update all matched
        mongoTemplate.updateMulti(query4, update4, User.class);

        System.out.println(query4.toString());

        List<User> usersTest4 = mongoTemplate.find(query4, User.class);
        ...
        mongoTemplate.upsert(query5, update5, User.class);

        User userTest5 = mongoTemplate.findOne(query5, User.class);
        ...
        User userTest6 = mongoTemplate.findAndModify(query6, update6, new FindAndModifyOptions().returnNew(true), User.class);
